    ...
    <div className="flex flex-col min-h-screen bg-white pb-10">
      ...
      <div className="bg-orange-500 text-white p-4 sm:p-6 rounded-b-3xl shadow-lg w-full flex items-center gap-3 sm:gap-4">
        ...
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold mb-1" style={{ whiteSpace: 'nowrap' }}>SDS | Simple Drive Solution</h1>
      ...
      {currentBanner && (
        <div className="px-4 mt-6 max-w-md mx-auto w-full space-y-4">
          <div key={currentBanner.id} className="bg-orange-100 rounded-md p-4 shadow-lg border border-orange-200 border-l-4 border-l-orange-500 flex items-center gap-4 relative overflow-hidden">
