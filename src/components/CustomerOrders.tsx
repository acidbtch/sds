                                ...
                                try {
                                  ...
                                  if (found) {
                                    setSelectedContractor({
                                      ...
                                      services: (found.services || []).map((s: any) => s.name || s),
                                      regions: (found.regions || []).map((r: any) => r.name || r),
                                      ...
                                      logo: found.logo_url || found.avatar_url || '',
                                      photos: found.portfolio_photos || found.photos || [],
                                      legalDocs: found.legal_documents || [],
